### About
Spot is innovative way to create Cryptonote (https://cryptonote.org) based cryptotokens. It gives the users the ability to create cryptotokens just by creating a simple configuration file.
...
https://github.com/spot/cryptonote-generator/blob/master/docs/windows-requirements-install.md

Ubuntu (tested on Ubuntu 14.04) / Mac dependencies install script:
https://github.com/spot/cryptonote-generator/blob/master/configure.sh


### Usage
1. Download or compile the binaries
2. Create configuration file. The easiest way is to use the form on http://spot.net
3. Start the daemon:
```
...
Use http://spot.net to create configuration files.

All fields supported:
```
GENESIS_COINBASE_TX_HEX=     // REQUIRED. Use " ./spotd --config-file PATH_TO_CONFIG --print-genesis-tx " to generate 
...
---
This code is generated by Cryptonote generator - https://github.com/spot/cryptonote-generator
